...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            int res =Emps.Max(e => e.Salary);
            IEnumerable<Emp> result = Emps.Where(e => e.Salary == res);
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => Emps.Any(sub => sub.Mgr?.Empno == e.Empno))
                .OrderBy(e => e.Ename)
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            IEnumerable<Dept> result = Depts.Where(d => deptCounts.Any(dc => dc.Deptno == d.Deptno && (dc.Count == 5 || dc.Count == 0)))
                .OrderBy(d => d.Dname);
            //result =
            return result;
        }
